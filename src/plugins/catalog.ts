...
export const synapDomePlugins: SynapDomePlugin[] = [
  ...
  },
  {
    ...
    status: "external",
    description: "Client-side Burp extension concept for sending captured sitemap/proxy traffic to SynapDome as artifacts for follow-up scans.",
    requiredInputs: [
    ...
    artifacts: ["plugins/legacy/burp-suite/plugin-manifest.json"]
  },
  {
    ...
    stage: "legacy-client-plugin",
    status: "external",
    description: "Browser extension concept for capturing authorized DevTools traffic and sending HAR/API evidence to SynapDome.",
    requiredInputs: [
    ...
    artifacts: ["plugins/legacy/browser-extension/plugin-manifest.json"]
  }
];
...
export const roadmapStatus = {
  ...
  "Applications / Web / Burp": "plugin-handoff-created",
